...
const scrollCameraPosition = new THREE.Vector3(21, 19, 46);
const baseTarget = controls.target.clone();
const scrollTarget = new THREE.Vector3(0, 9, 0);

function updateScrollProgress() {
  if (!heroTrack) return;
  const maxScroll = Math.max(heroTrack.offsetHeight - window.innerHeight, 1);
